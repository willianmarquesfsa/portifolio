...
class WC_Order_Status_Manager_Loader {
	...
	const PLUGIN_NAME = 'WooCommerce Order Status Manager';


	/** @var \WC_Order_Status_Manager_Loader single instance of this class */
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-order-status-manager.php' );
	...
	/**
	 * Displays any admin notices added with \WC_Order_Status_Manager_Loader::add_admin_notice()
	 *
	 * @since 1.10.0
	 */
	...
	/**
	 * Gets the main \WC_Order_Status_Manager_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 1.10.0
	 *
	 * @return \WC_Order_Status_Manager_Loader
	 */
...
// fire it up!
WC_Order_Status_Manager_Loader::instance();
